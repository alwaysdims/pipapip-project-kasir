	...
	<div
		...
		<div class="h-full flex items-center">
			<!-- BEGIN: Logo --> <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block"> <img
					alt="Midone - HTML Admin Template" class="logo__image w-8 h-8 rounded overflow-hidden shadow-lg image-fit zoom-in scale-110"
					src="<?= base_url('assets/images/logo.jpg') ?>"> <span
					class="logo__text text-white text-lg ml-3"> AMDG Kasir </span> </a> <!-- END: Logo -->
			<!-- BEGIN: Breadcrumb -->
			...
			<div class="intro-x dropdown w-8 h-8">
				<div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in scale-110"
					role="button" aria-expanded="false" data-tw-toggle="dropdown"> <img
						...
						src="<?= base_url('assets/images/logo.jpg') ?>"> </div>
